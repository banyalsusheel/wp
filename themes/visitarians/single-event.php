							...
							?>	
						  	<li>
								...
								<div class="event-content">									
									...
									$location_data = get_location_of_event(get_the_ID());
							       	if(!empty($location_data)){?>
							       		<div class="event-location"><?php echo $location_data['location'];?>, <?php echo $location_region;?></div> | 
							       	<?php } ?>
								    ...
								    <div class="event-rating"> <?php echo average_rating(get_the_ID());?></div>
								    <div class="event-category"><?php echo $categories['categories']; ?></div>
									<div class="event-content"><?php echo substr(strip_tags($post->post_content), 0, 100); ?>
									</div>
